...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/WifiAssist1.0.0/ && $(COPY_FILE) --parents resources/icon.qrc .tmp/WifiAssist1.0.0/ && $(COPY_FILE) --parents src/mainwindow.h src/wifi.h src/wsettings.h src/wdevices.h .tmp/WifiAssist1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/mainwindow.cpp src/wifi.cpp src/wsettings.cpp src/wdevices.cpp .tmp/WifiAssist1.0.0/ && $(COPY_FILE) --parents src/mainwindow.ui .tmp/WifiAssist1.0.0/ && (cd `dirname .tmp/WifiAssist1.0.0` && $(TAR) WifiAssist1.0.0.tar WifiAssist1.0.0 && $(COMPRESS) WifiAssist1.0.0.tar) && $(MOVE) `dirname .tmp/WifiAssist1.0.0`/WifiAssist1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/WifiAssist1.0.0
